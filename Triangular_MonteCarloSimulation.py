# Model 1: Triangular Monte Carlo Simulation (Universal Loader with Silent Tkinter)
import pandas as pd
import numpy as np
...
for i, row in df_clean.iterrows():
    task_sim_matrix[:, i] = np.random.triangular(
...
plt.title('Model 1: Triangular Simulation of Total Project Cost')
...
plt.title("Tornado Chart: Sensitivity of Tasks (Triangular)")
...
plt.axvline(0, color='black', linewidth=0.8)
plt.title("Correlation: Task Cost vs Total Cost (Triangular)")
